...
function AdminDropdown() {
  ...
  return (
    <div className="relative hover:bg-slate-100 active:bg-slate-200 transition-colors duration-200 rounded-md">
      {/* Admin Info Button */}
      <button
      ...
      <Dropdown isOpen={isOpen} onClose={closeDropdown}>
        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-slate-200">
          ...
          <li>
            <DropdownItem onItemClick={closeDropdown} to="/client/xyz">
              <svg
                className="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300"
                width="24"
                height="24"
